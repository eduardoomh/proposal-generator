...
export const pdfContent: PDFContentI[] = [
    ...
    "language": "en",
    "general": {
        "text_1": "<p>This document serves as a proposal for our project together and communicates some of the details of how we collaborate. This proposal is between IP Insights Managed Services, LLC (\"us\", \"we\", \"our\", \"IPI\") and ${company_name} (\"you\", \"your\").</p>"
    },
    "who_will_work": {
